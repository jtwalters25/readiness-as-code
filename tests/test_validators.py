...
class TestMarkdownReport:
    """Tests for ready.ready.generate_markdown — the --markdown flag output."""

    def test_generate_markdown_renders_all_sections(
        self, sample_repo, definitions_path, empty_evidence, empty_exceptions
    ):
        from ready.ready import generate_markdown
        ...
        # Summary row counts must match the scan
    ...
    def test_markdown_file_is_written(
        self, sample_repo, definitions_path, empty_evidence, empty_exceptions, tmp_path
    ):
        """Round-trip: generate_markdown output written to disk is readable UTF-8."""
        from ready.ready import generate_markdown
    ...
    def test_grouped_passing_strikethrough(
        self, sample_repo, definitions_path, empty_evidence, empty_exceptions
    ):
        from ready.ready import generate_markdown
